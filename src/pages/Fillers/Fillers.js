...
function Fillers() {
  return (
   <div className="fillers">
    <h2 className='caption2'>I love capturing laughter,giggles and lovely memories!<br/>I offer newborn,family,maternity and eventphotography.<br/>if you want anything else let's chat and we can come up with something to fit what you need!</h2>
    <div className="footer__socials5">
